...
export default class customImageCompress extends ImageCompress {
  quill: any;
  options: any;
  range: any;
  debug: boolean;
  ...
  constructor(quill, options) {
    ...
    toolbar.addHandler("routerLinkImage", this.selectLocalImage.bind(this));
    // this.update();
  }
...
// if (window.Quill) {
Quill.register("modules/customImageCompress", customImageCompress);
// }
